...
public class Enemy extends Entity{
	...
	public int vida = 20;                  //Entity.rand.nextInt(200-60)+60; ENEMY NAO TER VIDA IGUAL A TODOS
	...
	public void render(Graphics g) {
		...
		g.fillRect(this.getX()- 4 - Camera.x, this.getY()- 8 - Camera.y,30,7); ///POSIÇAO DA BARRA
